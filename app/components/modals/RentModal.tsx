...
const RentModal = () => {
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading
        title="Что из этого лучше всего описывает ваше заведение?"
  ...
  if (step === STEPS.LOCATION) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Где находится ваше заведение?"
  ...
  if (step === STEPS.INFO) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Поделитесь основными сведениями о вашем заведении"
  ...
  if (step === STEPS.IMAGES) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Добавьте фотографию вашего заведения"
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Краткость сестра таланта!"
        />
        <Input
          id="title"
          label="Имя"
